...
function M.hi_extd()
    ...
    set_hi('markdownH4',               vim.g.terminal_color_1, nil, nil)
    set_hi('markdownH5',               vim.g.terminal_color_1, nil, nil)
    set_hi('markdownH6',               vim.g.terminal_color_1, nil, nil)
    set_hi('markdownHeadingDelimiter', vim.g.terminal_color_1, nil, 'bold')
    ...
    set_hi('markdownTSPunctDelimiter', vim.g.terminal_color_8, nil, nil)
